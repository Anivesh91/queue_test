...
export const TicketTrackerPage = () => {
  ...
  const orgBackUrl = organization?.slug ? `/customer/organizations/${organization.slug}` : '/customer';
    ...
    <div className="max-w-lg mx-auto px-4 py-8 sm:py-12">
      ...
      <div className="mb-4">
        ...
        >
          ...
          <span>Back to {organization?.name || 'Queues'}</span>
        </Link>
      </div>
          ...
          {status === 'COMPLETED' && (
            <div className="text-center py-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 max-w-xs mx-auto mt-1">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-2.5">
                <Link
                  to={orgBackUrl}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-4 py-2.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 rounded-xl transition-all shadow-xs"
                >
                  <ArrowLeft className="w-3.5 h-3.5" />
                  <span>Back to {organization?.name || 'Services'}</span>
                </Link>
                <Link
                  to="/customer"
                  className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl transition-colors"
                >
                  <span>Queue Directory</span>
                </Link>
              </div>
            </div>
          )}
            ...
            <div className="text-center py-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 max-w-xs mx-auto mt-1">
                  You have left this virtual queue. You can return to the organization page and join again anytime.
                </p>
              </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-2.5">
                <Link
                  to={orgBackUrl}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-5 py-2.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 rounded-xl transition-all shadow-xs"
                >
                  <ArrowLeft className="w-3.5 h-3.5" />
                  <span>Go Back to {organization?.name || 'Services'}</span>
                </Link>
                <Link
                  to="/customer"
                  className="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-xl transition-colors"
          ...
          {status === 'NO_SHOW' && (
            <div className="text-center py-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 max-w-xs mx-auto mt-1">
                  The counter operator called your number, but you were marked absent. You can return to the organization and get a new ticket below.
                </p>
              </div>
