  ...
  if (error || !organization) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        ...
        <p className="text-xs text-slate-500 mt-1">{error || 'This organization does not exist or is inactive.'}</p>
        <Link
          to="/customer"
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm mb-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <span className="text-xs font-bold text-blue-700 bg-blue-50 px-3 py-1 rounded-full border border-blue-100 uppercase tracking-wider">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-slate-900">Available Service Queues</h2>
        ...
        {organization.services && organization.services.length > 0 ? (
          ...
          <div className="bg-white rounded-2xl p-10 text-center border border-slate-200">
            ...
            <h3 className="text-sm font-bold text-slate-700">No Services Available</h3>
